# RuView 能做什么：安防、康养、存在检测与无摄像头感知场景
> 项目地址：https://github.com/ruvnet/RuView

![RuView 应用场景配图](https://opengraph.githubassets.com/1/ruvnet/RuView)
...
<div style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin:18px 0 22px 0;">
  ...
  <div style="border:1px solid #e5e7eb;border-radius:14px;padding:14px;background:#ffffff;"><strong>项目类型：</strong>应用场景 / 无摄像头感知</div>
  <div style="border:1px solid #e5e7eb;border-radius:14px;padding:14px;background:#ffffff;"><strong>上手难度：</strong>⭐⭐</div>
  <div style="border:1px solid #e5e7eb;border-radius:14px;padding:14px;background:#ffffff;"><strong>推荐部署：</strong>安防 / 康养 / 检测</div>
  <div style="border:1px solid #e5e7eb;border-radius:14px;padding:14px;background:#ffffff;"><strong>适合人群：</strong>想评估落地场景的人</div>
...
> **RuView 的想象空间很大，真正有价值的不是“炫技”，而是无摄像头感知在现实场景里的落地。**
